    ...
    def _run(self) -> None:
        try:
            ...
            cfg = PipelineConfig(
                ...
                srp_overlap=float(self.req.overlap),
                srp_freq_min_hz=int(self.req.freq_low_hz),
                srp_freq_max_hz=int(self.req.freq_high_hz),
                localization_vad_enabled=bool(self.req.localization_vad_enabled),
                localization_vad_rms_floor=float(self.req.localization_vad_rms_floor),
                localization_vad_speech_ratio_threshold=float(self.req.localization_vad_speech_ratio_threshold),
                localization_vad_rms_ratio_threshold=float(self.req.localization_vad_rms_ratio_threshold),
                localization_vad_flux_threshold=float(self.req.localization_vad_flux_threshold),
                localization_snr_gating_enabled=bool(self.req.localization_snr_gating_enabled),
                localization_snr_threshold_db=float(self.req.localization_snr_threshold_db),
                localization_snr_soft_range_db=float(self.req.localization_snr_soft_range_db),
                localization_snr_weight_exponent=float(self.req.localization_snr_weight_exponent),
                localization_noise_floor_alpha_fast=float(self.req.localization_noise_floor_alpha_fast),
                localization_noise_floor_alpha_slow=float(self.req.localization_noise_floor_alpha_slow),
                localization_msc_variance_enabled=bool(self.req.localization_msc_variance_enabled),
                localization_msc_history_frames=int(self.req.localization_msc_history_frames),
                localization_msc_variance_floor=float(self.req.localization_msc_variance_floor),
                localization_msc_weight_exponent=float(self.req.localization_msc_weight_exponent),
                localization_hsda_enabled=bool(self.req.localization_hsda_enabled),
                localization_hsda_window_frames=int(self.req.localization_hsda_window_frames),
