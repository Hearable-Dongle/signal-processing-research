...
def run_once(args):
    ...
    if args.backend != "torch_proxy":
        raise RuntimeError(
            "hailo_runtime backend is not available in this environment. "
            "Run torch_proxy here and runtime backend on target machine with runtime package."
        )
