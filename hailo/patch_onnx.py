...
def main():
    parser = argparse.ArgumentParser(description="Patch ONNX model for Hailo compatibility")
    parser.add_argument("input", nargs="?", default="hailo/convtas_hailo_ready.onnx", help="Input ONNX file path")
    parser.add_argument("output", nargs="?", default="hailo/convtas_hailo_ready_patched.onnx", help="Output ONNX file path")
