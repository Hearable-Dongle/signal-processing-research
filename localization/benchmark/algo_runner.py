...
def _build_algorithm(method: str, mic_pos_rel: np.ndarray, fs: int, n_true_targets: int, cfg: dict):
    ...
    realtime_common = {
        **common,
        ...
        "capon_freq_bin_subsample_stride": cfg.get("capon_freq_bin_subsample_stride", 1),
        "capon_freq_bin_min_hz": cfg.get("capon_freq_bin_min_hz"),
        "capon_freq_bin_max_hz": cfg.get("capon_freq_bin_max_hz"),
        "capon_use_cholesky_solve": cfg.get("capon_use_cholesky_solve", False),
        "capon_covariance_ema_alpha": cfg.get("capon_covariance_ema_alpha", 0.0),
        "capon_full_scan_every_n_updates": cfg.get("capon_full_scan_every_n_updates", 1),
        "capon_local_refine_enabled": cfg.get("capon_local_refine_enabled", False),
        "capon_local_refine_half_width_deg": cfg.get("capon_local_refine_half_width_deg", 30.0),
