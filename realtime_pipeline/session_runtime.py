...
def build_pipeline_config_from_request(
    ...
    *,
    ...
    return PipelineConfig(
        ...
        delay_sum_subtractive_silence_guard_enabled=bool(req.delay_sum_subtractive_silence_guard_enabled),
        delay_sum_subtractive_silence_guard_ratio_threshold=float(req.delay_sum_subtractive_silence_guard_ratio_threshold),
        delay_sum_subtractive_silence_guard_target_rms_floor=float(req.delay_sum_subtractive_silence_guard_target_rms_floor),
        delay_sum_subtractive_spike_guard_enabled=bool(req.delay_sum_subtractive_spike_guard_enabled),
        delay_sum_subtractive_spike_guard_rms_ratio_threshold=float(req.delay_sum_subtractive_spike_guard_rms_ratio_threshold),
        delay_sum_subtractive_spike_guard_peak_ratio_threshold=float(req.delay_sum_subtractive_spike_guard_peak_ratio_threshold),
        delay_sum_subtractive_spike_guard_sample_jump_threshold=float(req.delay_sum_subtractive_spike_guard_sample_jump_threshold),
        delay_sum_subtractive_output_crossfade_enabled=bool(req.delay_sum_subtractive_output_crossfade_enabled),
        delay_sum_subtractive_output_crossfade_samples=int(req.delay_sum_subtractive_output_crossfade_samples),
        delay_sum_subtractive_declick_enabled=bool(req.delay_sum_subtractive_declick_enabled),
        delay_sum_subtractive_declick_alpha=float(req.delay_sum_subtractive_declick_alpha),
        delay_sum_subtractive_declick_spike_threshold=float(req.delay_sum_subtractive_declick_spike_threshold),
        delay_sum_subtractive_interferer_ema_enabled=bool(req.delay_sum_subtractive_interferer_ema_enabled),
        delay_sum_subtractive_interferer_ema_alpha=float(req.delay_sum_subtractive_interferer_ema_alpha),
        delay_sum_subtractive_adaptive_alpha_enabled=bool(req.delay_sum_subtractive_adaptive_alpha_enabled),
        delay_sum_subtractive_adaptive_alpha_min=float(req.delay_sum_subtractive_adaptive_alpha_min),
        delay_sum_subtractive_adaptive_alpha_delta_scale=float(req.delay_sum_subtractive_adaptive_alpha_delta_scale),
        ...
        rnnoise_voice_eq_enabled=bool(req.rnnoise_voice_eq_enabled),
        rnnoise_voice_eq_presence_gain_db=float(req.rnnoise_voice_eq_presence_gain_db),
        rnnoise_voice_eq_presence_center_hz=float(req.rnnoise_voice_eq_presence_center_hz),
        rnnoise_voice_eq_presence_q=float(req.rnnoise_voice_eq_presence_q),
        rnnoise_voice_eq_lowmid_gain_db=float(req.rnnoise_voice_eq_lowmid_gain_db),
        rnnoise_voice_eq_lowmid_center_hz=float(req.rnnoise_voice_eq_lowmid_center_hz),
        rnnoise_voice_eq_lowmid_q=float(req.rnnoise_voice_eq_lowmid_q),
...
def run_offline_session_pipeline(
    *,
    ...
    summary: dict[str, Any] = {
        ...
        "rnnoise_voice_eq_enabled": bool(cfg.rnnoise_voice_eq_enabled),
        "rnnoise_voice_eq_presence_gain_db": float(cfg.rnnoise_voice_eq_presence_gain_db),
        "rnnoise_voice_eq_presence_center_hz": float(cfg.rnnoise_voice_eq_presence_center_hz),
        "rnnoise_voice_eq_presence_q": float(cfg.rnnoise_voice_eq_presence_q),
        "rnnoise_voice_eq_lowmid_gain_db": float(cfg.rnnoise_voice_eq_lowmid_gain_db),
        "rnnoise_voice_eq_lowmid_center_hz": float(cfg.rnnoise_voice_eq_lowmid_center_hz),
        "rnnoise_voice_eq_lowmid_q": float(cfg.rnnoise_voice_eq_lowmid_q),
        ...
        "delay_sum_subtractive_silence_guard_enabled": bool(cfg.delay_sum_subtractive_silence_guard_enabled),
        "delay_sum_subtractive_silence_guard_ratio_threshold": float(cfg.delay_sum_subtractive_silence_guard_ratio_threshold),
        "delay_sum_subtractive_silence_guard_target_rms_floor": float(cfg.delay_sum_subtractive_silence_guard_target_rms_floor),
        "delay_sum_subtractive_spike_guard_enabled": bool(cfg.delay_sum_subtractive_spike_guard_enabled),
        "delay_sum_subtractive_spike_guard_rms_ratio_threshold": float(cfg.delay_sum_subtractive_spike_guard_rms_ratio_threshold),
        "delay_sum_subtractive_spike_guard_peak_ratio_threshold": float(cfg.delay_sum_subtractive_spike_guard_peak_ratio_threshold),
        "delay_sum_subtractive_spike_guard_sample_jump_threshold": float(cfg.delay_sum_subtractive_spike_guard_sample_jump_threshold),
        "delay_sum_subtractive_output_crossfade_enabled": bool(cfg.delay_sum_subtractive_output_crossfade_enabled),
        "delay_sum_subtractive_output_crossfade_samples": int(cfg.delay_sum_subtractive_output_crossfade_samples),
        "delay_sum_subtractive_declick_enabled": bool(cfg.delay_sum_subtractive_declick_enabled),
        "delay_sum_subtractive_declick_alpha": float(cfg.delay_sum_subtractive_declick_alpha),
        "delay_sum_subtractive_declick_spike_threshold": float(cfg.delay_sum_subtractive_declick_spike_threshold),
        "delay_sum_subtractive_interferer_ema_enabled": bool(cfg.delay_sum_subtractive_interferer_ema_enabled),
        "delay_sum_subtractive_interferer_ema_alpha": float(cfg.delay_sum_subtractive_interferer_ema_alpha),
        "delay_sum_subtractive_adaptive_alpha_enabled": bool(cfg.delay_sum_subtractive_adaptive_alpha_enabled),
        "delay_sum_subtractive_adaptive_alpha_min": float(cfg.delay_sum_subtractive_adaptive_alpha_min),
        "delay_sum_subtractive_adaptive_alpha_delta_scale": float(cfg.delay_sum_subtractive_adaptive_alpha_delta_scale),
