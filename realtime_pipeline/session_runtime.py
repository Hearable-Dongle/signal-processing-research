...
def build_pipeline_config_from_request(
    ...
    *,
    ...
    return PipelineConfig(
        ...
        output_enhancer_mode=str(req.output_enhancer_mode),
        output_enhancer_frame_ms=float(req.output_enhancer_frame_ms),
...
def run_offline_session_pipeline(
    *,
    ...
    summary: dict[str, Any] = {
        ...
        "output_enhancer_mode": str(cfg.output_enhancer_mode),
        "output_enhancer_frame_ms": float(cfg.output_enhancer_frame_ms),
