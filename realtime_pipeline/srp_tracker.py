    ...
    def __init__(
        ...
        *,
        ...
        self._backend = build_localization_backend(
            ...
            algo_kwargs={
                "vad_enabled": bool(localization_vad_enabled),
                "vad_rms_floor": float(localization_vad_rms_floor),
                "vad_speech_ratio_threshold": float(localization_vad_speech_ratio_threshold),
                "vad_rms_ratio_threshold": float(localization_vad_rms_ratio_threshold),
                "vad_flux_threshold": float(localization_vad_flux_threshold),
                "snr_gating_enabled": bool(localization_snr_gating_enabled),
                "snr_threshold_db": float(localization_snr_threshold_db),
                "snr_soft_range_db": float(localization_snr_soft_range_db),
                "snr_weight_exponent": float(localization_snr_weight_exponent),
                "noise_floor_alpha_fast": float(localization_noise_floor_alpha_fast),
                "noise_floor_alpha_slow": float(localization_noise_floor_alpha_slow),
                "msc_variance_enabled": bool(localization_msc_variance_enabled),
                "msc_history_frames": int(localization_msc_history_frames),
                "msc_variance_floor": float(localization_msc_variance_floor),
                "msc_weight_exponent": float(localization_msc_weight_exponent),
                "hsda_enabled": bool(localization_hsda_enabled),
                "hsda_window_frames": int(localization_hsda_window_frames),
            },
        )
